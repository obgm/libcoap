...
/* Note: libcoap uses 8 byte allocation from defined value for tracking alloc sizes */
LWIP_MALLOC_MEMPOOL_START
LWIP_MALLOC_MEMPOOL(MEMP_NUM_COAPSTRING, 64)
LWIP_MALLOC_MEMPOOL(4, 256)
LWIP_MALLOC_MEMPOOL(2, 512)
LWIP_MALLOC_MEMPOOL(2, 1512)
LWIP_MALLOC_MEMPOOL_END
LWIP_MEMPOOL(COAP_STRING, 1, 1, "COAP_STRING")
